        ...
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="images/pfp.jpg" alt="..." width="150" class="rounded mb-2 img-thumbnail">
            ...
            <div class="bg-light p-4 d-flex justify-content-end text-center">
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">10</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Followers</small>
                    </li>
                    <li class="list-inline-item">
                        <h5 class="font-weight-bold mb-0 d-block">9</h5><small class="text-muted"> <i class="fas fa-user mr-1"></i>Following</small>
                    </li>
                </ul>
            </div>
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">Professional Dj</p>
                    <p class="font-italic mb-0">Overnighter</p>
                    <p class="font-italic mb-0">Adventurer/Hiker</p>
                </div>
            </div>
