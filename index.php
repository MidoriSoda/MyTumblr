...
$acc_username = "AndreiPalacios";
$acc_password = "imadethiswebpage";
$acc_fullname = "Andrei Palacios";
$acc_address = "Santa Cruz Marinduque PH";
...
//get the username and password from the form and compare to the predefined username and password for comparison
				...
				<form method="POST" class="login-form">
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist'])===true){
		      				...
		      				echo "<div class='alert alert-danger' role='alert'> Please Login First. </div>";
